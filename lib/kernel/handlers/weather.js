...
// "weather in Lebanon today?" yields "Lebanon today?" - which OpenWeather 404s on. Strip
// trailing punctuation and time/politeness filler words ("today", "right now", "this
// evening", "please", ...) so only the place name reaches the API. Never strips the last
// remaining word (a bare "today" stays "today" rather than becoming empty).
...
module.exports = {
  ...
  aggregateDaily, buildBoardPayload, cleanLocation
};
